...
const NotFoundPage = () => {
  ...
  useEffect(() => {
    ...
    const draw = (x, y) => {
      if (!pathRef.current || !ctxRef.current) return;
  ...
  return (
    <div className="relative w-full h-screen bg-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
        ...
        <Link
          to="/"
          className="mt-8 px-6 py-3 bg-white text-black rounded-full font-medium pointer-events-auto hover:bg-gray-200 transition-colors"
        >
          Go Home
        </Link>
      </div>
