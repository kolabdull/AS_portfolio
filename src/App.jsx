...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      name: "Anniekuku",
      type: "web",
      description: "An elegant e-commerce platform to discover handcrafted fine jewelry.",
      tech: ["React", "JavaScript", "Tailwind CSS", "PostgreSQL", "Cloudinary"],
      link: "https://anniekuku-frontend.vercel.app/",
      image: anniekukuImage,
    },
  ...
  // Hero animations (split + entrance + parallax)
  useEffect(() => {
    // Split text animation (top and bottom halves move apart on scroll)
    ...
    // Entrance animation for badge, name, tagline, buttons
  ...
  // Education & Work scroll animations
  useEffect(() => {
    // Liquid effect on Education title (fade‑up)
    ...
    // Ink transition for elements with js-ink-trigger
  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      {/* Hero Section with Split Screen & Parallax */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div ref={heroButtonsRef} className="flex flex-col sm:flex-row justify-center gap-4 opacity-0 translate-y-8">
              ...
              <GlowButton onClick={() => document.getElementById('work')?.scrollIntoView({ behavior: 'smooth' })}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 6H21M9 12H21M9 18H17" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
              </GlowButton>
              <button
                onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
      ...
      {/* Animated Boxes (your existing component) */}
      <AnimatedBoxes />
